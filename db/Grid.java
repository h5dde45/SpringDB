...
public class Grid {
    ...
    public float[] vertices = {
            -1, 1, 0,
            1, 1, 0,
            1, ProjectionMatrix.height / 2 / ProjectionMatrix.width - 1, 0,
            -1f, ProjectionMatrix.height / 2 / ProjectionMatrix.width - 1, 0
    };
    ...
    public Grid(Context context, int otMatrix) {
    ...
    public void draw() {
        glUniformMatrix4fv(otMatrix, 1, false, mT, 0);
